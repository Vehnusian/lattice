...
>
	...
	<div class="flex items-start justify-between gap-4 px-4 py-3 border-x border-b border-(--color-rule)">
		...
		<span
			class="shrink-0 font-mono text-[10px] uppercase tracking-wider text-(--color-ink-subtle)"
		>
